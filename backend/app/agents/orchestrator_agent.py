...
class CareerOrchestratorAgent(BaseAgent):
    ...
    async def run(self, inputs: Dict[str, Any], memory: Optional[Any] = None) -> Dict[str, Any]:
        ...
        dynamic_data = {
            "response": f"I am your CampusOS Career Orchestrator. Regarding '{prompt if prompt else 'your career journey'}': I recommend analyzing your resume with our **Resume Intelligence Agent** and benchmarking against your target job role using the **ATS Optimization Agent**.",
